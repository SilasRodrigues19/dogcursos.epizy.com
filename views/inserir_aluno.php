...
<form method="post" action="processa_aluno.php" id="formValidator">
	...
	<input class="form-control" type="text" name="nome_aluno" placeholder="Insira o nome do aluno" id="nome_aluno" >
	<br><br>
	<label class="badge badge-secondary">Data de nascimento:</label><br>
	<input class="form-control" type="text" name="data_nascimento" placeholder="Insira a data de nascimento (AAAA/MM/DD)" id="data_nascimento">
	<br><br>
