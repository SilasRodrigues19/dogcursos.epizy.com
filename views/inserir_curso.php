...
<form method="post" action="processa_curso.php" id="formValidator">
	<br>
	...
	<input class="form-control"  type="text" name="carga_horaria" placeholder="Insira a carga horária" id="carga_horaria"><br><br>
	<input type="submit" class="btn btn-dark" value="Inserir curso">
</form>
